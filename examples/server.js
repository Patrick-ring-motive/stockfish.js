...
var params = getParams({
  booleans: ["help", "h", "ssl", "list", "coop", "coep", "cors"]
});
params.cors = true;
var url = require("url");
var p = require("path");
...
function generateKeys() {
  ...
  var key;
  var cert = execFileSync("openssl", ["req", "-new", "-newkey", "rsa:4096", "-days", "9999", "-nodes", "-x509", "-subj", "/C=US/ST=State/L=Locality/O=Organization/CN=www.example.com", "-keyout", keyPem], {
    encoding: "utf8",
